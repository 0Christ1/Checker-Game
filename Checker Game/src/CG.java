...
public class CG extends JFrame implements ActionListener{
	...
	public CG() throws IllegalCheckerboardArgumentException {
        ...
        JLabel sign = new JLabel("This game was developed by Haoran Chen, April 2021", JLabel.CENTER);
        sp.add(sl);
        sp.add(sign);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("New"))
			...
			JOptionPane.showMessageDialog(this, "Haoran Chen, Miami University, 2021 Spring",
